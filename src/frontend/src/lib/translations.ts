  ...
  en: {
    ...
    homepage: {
      ...
      valueProposition: {
        ...
        onboardingDesc:
          "Join a welcoming community with clear membership tiers and approval processes",
        consensus: "Weekly Consensus Meetings",
        consensusDesc:
          "Participate in collaborative decision-making and earn reputation through consensus",
        governance: "Governance Activities",
        governanceDesc:
          "Shape the future of Phil3 through democratic proposals and voting",
        tokenomics: "Bitcoin-type Tokenomics",
        tokenomicsDesc:
          "Benefit from a deflationary token model with halving cycles and capped supply",
        rewards: "Daily Rewards",
        rewardsDesc:
          "Claim daily PHIL tokens based on your membership tier and activity level",
        multilang: "Multilanguage Support",
        multilangDesc:
          "Access the platform in English or French with full translation support",
      },
      features: {
        ...
        consensusDesc:
          "Participate in structured meetings with contribution, ranking, and reward phases",
        governance: "Democratic Governance",
        governanceDesc:
          "Vote on proposals and participate in community decision-making",
        tokenomics: "Token Economics",
        tokenomicsDesc:
          "Earn REP and PHIL tokens through participation and contributions",
        council: "Council System",
        councilDesc:
          "Top contributors form the council with special governance privileges",
        blog: "Community Blog",
        blogDesc:
          "Share ideas, engage with content, and tip authors with PHIL tokens",
        community: "Member Directory",
        communityDesc:
          "Connect with fellow philanthropists and track community growth",
      },
      cta: {
        title: "Join Phil3 Today",
        subtitle:
          "Start your journey in decentralized philanthropy and make a difference",
        button: "Get Started",
      },
    },
    login: {
      ...
      membershipDesc:
        "Join a structured community with clear membership tiers and approval processes",
      electionsTitle: "Democratic Elections",
      electionsDesc:
        "Participate in council elections and shape the future of Phil3",
      tokenSystemTitle: "Dual Token System",
      tokenSystemDesc:
        "Earn REP (reputation) and PHIL tokens through participation and contributions",
      ...
      missionGoal3:
        "By helping our members realize their first philanthropy goal.",
    ...
    overview: {
      ...
      joinCommunityDesc:
        "Submit a request to become a member and participate in governance",
      ...
      leaveConfirmDesc:
        "Are you sure you want to leave the Phil3 community? This action cannot be undone.",
    ...
    members: {
      ...
      accessRestrictedDesc:
        "Only admins and active members can view the members list",
    ...
    consensus: {
      ...
      membershipRequiredDesc:
        "You must be an approved member to participate in consensus meetings",
      ...
      reviewContributions:
        "Review contributions from your group members before ranking",
    ...
    council: {
      ...
      proposeNewActionDesc:
        "Create a new multi-signature action for council approval",
      actionId: "Action ID",
    ...
    uca: {
      ...
      description:
        "Please read and accept the User Contributor Agreement to continue",
      ...
      accepting: "Accepting...",
      pleaseConfirm:
        "Please confirm that you have read and accept the agreement",
  ...
  fr: {
    ...
    homepage: {
      ...
      valueProposition: {
        ...
        onboardingDesc:
          "Rejoignez une communauté accueillante avec des niveaux d'adhésion clairs et des processus d'approbation",
        consensus: "Réunions de consensus hebdomadaires",
        consensusDesc:
          "Participez à la prise de décision collaborative et gagnez de la réputation grâce au consensus",
        governance: "Activités de gouvernance",
        governanceDesc:
          "Façonnez l'avenir de Phil3 grâce à des propositions et des votes démocratiques",
        tokenomics: "Tokenomics de type Bitcoin",
        tokenomicsDesc:
          "Bénéficiez d'un modèle de jeton déflationniste avec des cycles de réduction de moitié et une offre plafonnée",
        rewards: "Récompenses quotidiennes",
        rewardsDesc:
          "Réclamez des jetons PHIL quotidiens en fonction de votre niveau d'adhésion et de votre niveau d'activité",
        multilang: "Support multilingue",
        multilangDesc:
          "Accédez à la plateforme en anglais ou en français avec une traduction complète",
      },
      features: {
        title: "Fonctionnalités de la plateforme",
        subtitle:
          "Tout ce dont vous avez besoin pour la philanthropie décentralisée",
        consensus: "Réunions de consensus",
        consensusDesc:
          "Participez à des réunions structurées avec des phases de contribution, de classement et de récompense",
        governance: "Gouvernance démocratique",
        governanceDesc:
          "Votez sur les propositions et participez à la prise de décision communautaire",
        tokenomics: "Économie des jetons",
        tokenomicsDesc:
          "Gagnez des jetons REP et PHIL grâce à la participation et aux contributions",
        council: "Système de conseil",
        councilDesc:
          "Les meilleurs contributeurs forment le conseil avec des privilèges de gouvernance spéciaux",
        blog: "Blog communautaire",
        blogDesc:
          "Partagez des idées, interagissez avec le contenu et donnez des pourboires aux auteurs avec des jetons PHIL",
        community: "Annuaire des membres",
        communityDesc:
          "Connectez-vous avec d'autres philanthropes et suivez la croissance de la communauté",
      },
      cta: {
        title: "Rejoignez Phil3 aujourd'hui",
        subtitle:
          "Commencez votre voyage dans la philanthropie décentralisée et faites la différence",
        button: "Commencer",
      },
    },
    login: {
      ...
      membershipDesc:
        "Rejoignez une communauté structurée avec des niveaux d'adhésion clairs et des processus d'approbation",
      electionsTitle: "Élections démocratiques",
      electionsDesc:
        "Participez aux élections du conseil et façonnez l'avenir de Phil3",
      tokenSystemTitle: "Système à double jeton",
      tokenSystemDesc:
        "Gagnez des jetons REP (réputation) et PHIL grâce à la participation et aux contributions",
      secureTitle: "Sécurisé et décentralisé",
      secureDesc:
        "Construit sur l'Internet Computer avec authentification Internet Identity",
      getStarted: "Commencer",
      getStartedDesc:
        "Connectez-vous avec Internet Identity pour commencer votre voyage",
      loginButton: "Se connecter avec Internet Identity",
      connecting: "Connexion...",
      missionIntro:
        "Phil3 est une plateforme innovante conçue pour une nouvelle génération de philanthropes qui souhaitent contribuer à la réalisation de missions partagées.",
      missionStatement:
        "La mission de Phil3 est de démocratiser la philanthropie à l'ère du web3. Comment faisons-nous cela ?",
      missionGoal1: "En construisant une plateforme fonctionnelle",
      missionGoal2: "En augmentant notre base de membres",
      missionGoal3:
        "En aidant nos membres à réaliser leur premier objectif philanthropique.",
      communityDescription:
        "Rejoignez une communauté décentralisée où les membres participent à la gouvernance démocratique, gagnent des récompenses grâce à des réunions de consensus et façonnent l'avenir des initiatives philanthropiques sur l'Internet Computer",
    },
    profileSetup: {
    ...
    overview: {
      ...
      joinCommunityDesc:
        "Soumettez une demande pour devenir membre et participer à la gouvernance",
      ...
      leaveConfirmDesc:
        "Êtes-vous sûr de vouloir quitter la communauté Phil3 ? Cette action ne peut pas être annulée.",
    ...
    members: {
      ...
      accessRestrictedDesc:
        "Seuls les administrateurs et les membres actifs peuvent voir la liste des membres",
      pendingRequests: "Demandes d'adhésion en attente",
      pendingRequestsDesc:
        "Examiner et approuver les nouvelles demandes de membres",
      username: "Nom d'utilisateur",
      email: "Email",
    ...
    consensus: {
      ...
      membershipRequiredDesc:
        "Vous devez être un membre approuvé pour participer aux réunions de consensus",
      joinMeeting: "Rejoindre la réunion",
      joinMeetingDesc:
        "Inscrivez-vous pour participer à cette réunion de consensus",
      ...
      pastMeetingsDesc:
        "Voir les résultats des réunions de consensus précédentes",
      ...
      rankMembersDesc:
        "Faites glisser pour réorganiser les membres par contribution",
      results: "Résultats",
      ...
      consensusReachedDesc:
        "Le groupe a atteint un consensus sur les classements",
      ...
      allRankedNoConsensus:
        "Tous les membres ont classé, mais aucun consensus n'a été atteint",
      reviewContributions:
        "Examinez les contributions des membres de votre groupe avant de classer",
    ...
    council: {
      ...
      proposeNewActionDesc:
        "Créer une nouvelle action multi-signature pour l'approbation du conseil",
      ...
      treasuryManagementDesc:
        "Gérer les fonds et les allocations de la communauté",
      tokenDistribution: "Distribution des jetons",
      tokenDistributionDesc:
        "Superviser la distribution des jetons REP et PHIL",
      proposalVoting: "Vote sur les propositions",
      proposalVotingDesc:
        "Voter sur les propositions et initiatives de la communauté",
      status: "Statut",
    ...
    blog: {
      ...
      cannotTipOwnPost:
        "Impossible de donner un pourboire à votre propre article",
    },
    documentation: {
      title: "Documentation",
      subtitle:
        "Découvrez les fonctionnalités de Phil3 et comment les utiliser",
      searchPlaceholder: "Rechercher dans la documentation...",
      noResultsTitle: "Aucun résultat trouvé",
      noResultsDesc:
        "Essayez différents mots-clés ou parcourez les sections ci-dessous",
    ...
    proposals: {
      ...
      accessDenied:
        "Seuls les membres actifs peuvent voir et créer des propositions",
      ...
      infoApprove:
        "Les membres du conseil et les administrateurs peuvent voter",
      infoMultisig: "3 approbations ou rejets nécessaires",
      infoNotifications:
        "Les auteurs reçoivent des notifications sur les décisions",
    },
    wallet: {
      title: "Portefeuille",
    ...
    uca: {
      ...
      description:
        "Veuillez lire et accepter l'accord de contributeur utilisateur pour continuer",
      loadingAgreement: "Chargement de l'accord...",
      acceptCheckbox:
        "J'ai lu et j'accepte l'accord de contributeur utilisateur",
