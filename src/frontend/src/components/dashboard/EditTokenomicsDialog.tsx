...
export default function EditTokenomicsDialog({
  open,
  onOpenChange,
  currentConfig,
}: EditTokenomicsDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
              ...
              <PopoverTrigger asChild>
                ...
                >
                  ...
                  {selectedDate ? (
                    format(
                      selectedDate,
                      locale === "en" ? "PPP HH:mm" : "PPP HH:mm",
                    )
                  ) : (
                    <span>
                      {locale === "en" ? "Pick a date" : "Choisir une date"}
                    </span>
                  )}
                </Button>
              </PopoverTrigger>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} disabled={updateConfig.isPending}>
